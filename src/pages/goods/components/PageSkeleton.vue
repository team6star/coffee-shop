  ...
  <view class="sk-container">
    ...
    >
      <view class="goods goods">
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-44 sk-text"
              >128.00</text
            >
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-432 sk-text"
            >钻石陶瓷涂层多用锅18cm 小奶锅</view
          >
          <view class="desc sk-transparent sk-text-0-0000-394 sk-text"
            >安全耐用，易于清洗APP</view
          >
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-14 sk-text"
              >选择</text
            >
            <text
              class="text ellipsis sk-transparent sk-text-14-2857-325 sk-text"
            >
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-902 sk-text"
              >送至</text
            >
            <text
              class="text ellipsis sk-transparent sk-text-14-2857-244 sk-text"
            >
              请选择收获地址
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-188 sk-text"
              >服务</text
            >
            <text
              class="text ellipsis sk-transparent sk-text-14-2857-648 sk-text"
            >
              无忧退 快速退款 免费包邮
            </text>
          </view>
      ...
      <view class="detail detail panel panel">
        <view class="title title">
          <text class="sk-transparent sk-text-0-0000-336 sk-text">详情</text>
        </view>
        <view class="content content">
          <view class="properties properties">
            <view class="item item">
              <text class="label sk-transparent sk-text-25-0000-177 sk-text"
                >额定电压功率</text
              >
              <text class="value sk-transparent sk-text-25-0000-513 sk-text"
                >120V 50/60Hz 1200W</text
              >
            </view>
          </view>
        </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 34px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-31-9444-703 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-31-9444-677 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
